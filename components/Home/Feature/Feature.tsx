  ...
  return (
    <div className="pt-16 pb-16">
      ...
      <div className="w-[80%] mx-auto mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
        ...
        <div>
          <FeatureCard icon="/images/f2.svg" title="Largest People" />
        </div>
        <div>
          <FeatureCard icon="/images/f3.svg" title="Wide Coverage Map" />
        </div>
        <div>
          <FeatureCard icon="/images/f4.svg" title="Artificial Intelligence" />
        </div>
        <div>
          <FeatureCard icon="/images/f5.svg" title="Trusted & Secure" />
        </div>
        <div>
